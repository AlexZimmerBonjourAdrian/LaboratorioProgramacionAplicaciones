...
public class Publicador {
  ...
  public void altausuario(String nick, String nombre, String ape, String correo, String fecha, String contr, boolean docente, String imagendir, List inst) throws ParseException{
   ...
   @WebMethod
   public void crearInscripcionEstudiante(String nombreC, String nombreEdi, String nombreEst){
       ICU.crearInscripcionEstudiante(nombreC, nombreEdi, nombreEst, new Date());
   }
   ...
   @WebMethod
   public void modificarEstadoInscripcion(String cur, String ed, String est){
   
       ICU.modificarEstadoInscripcion(cur, ed, est, EstadoInscripcion.ACEPTADA);
   }
