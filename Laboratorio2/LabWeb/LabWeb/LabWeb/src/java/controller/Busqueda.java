...
public class Busqueda extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Set<DTCurso> cursos = ICU.datosCursos();
        Set<DTPrograma> programas = ICU.datosProgramas();
        String resultado = ""; 
        ...
        if(busqueda.length()>=3){
            for(DTCurso c : cursos){
                ...
                if(mat1.matches()|| mat2.matches()){
                   ...
                   "<h3 class=\"panel-title\"><a href=\"cursodatos?cur=" + c.getNombre()+"\"> Curso: " + c.getNombre() + "</a></h3></div>" +
