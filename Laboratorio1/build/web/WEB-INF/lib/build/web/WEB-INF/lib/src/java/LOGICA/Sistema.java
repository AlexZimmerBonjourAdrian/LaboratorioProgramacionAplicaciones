...
public class Sistema implements ISistema{
    ...
    public void altaUsuario(DTUsuario datos, boolean docente, List nomInst){
        ...
        Instituto inst;
        if(docente){
              u = new Docente(datos.getNick(),datos.getNombre(),datos.getApellido(),datos.getCorreo(),datos.getFecha(),datos.getContrasena());
              ...
              u = new Estudiante(datos.getNick(),datos.getNombre(),datos.getApellido(),datos.getCorreo(),datos.getFecha(), datos.getContrasena());
        }
        sm.agregarUsuario(u);
        //try catch
        em.getTransaction().begin();
    ...
    public DTUsuario obtenerUsuario(String nick){
       ...
       if(u!=null){
          ...
          return new DTUsuario(u.getNick(), u.getNombre(), u.getApellido(), u.getCorreo(), u.getFecha_de_nac(), u.getContrasena()); 
       }
       else{
 ...
 //       EntityManager em = p.obtenerEntityManager();
    ...
    public Set<DTCurso> DTcursosPrograma(String nombreP){
     ...
     public ArrayList<String> listarDocentesEdicion(String nombreC, String nombreE){
        ...
        while(it.hasNext()){
            Map.Entry<String,Docente> doc = it.next();
            docentesE.add(doc.getValue().getApellido());
        }
        return docentesE;
    }
