 ...
 * @author admin
 */
public class CancelarInscripcion extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(nick2!=null && !port.chekusuario(nick2)&& !port.esDocente(nick2)){
            request.getRequestDispatcher("/WEB-INF/Edicion/CancelarInscripcion.jsp").forward(request, response);
        }
        else{
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if(nick2!=null && !port.chekusuario(nick2)&& !port.esDocente(nick2)){
            if(seleccion!=null){
                port.modificarEstadoInscripcion(datos[0], datos[1], nick2, EstadoInscripcion.CANCELADA);
            }
            request.getRequestDispatcher("/WEB-INF/Edicion/CancelarInscripcion.jsp").forward(request, response);
        }
        else{
