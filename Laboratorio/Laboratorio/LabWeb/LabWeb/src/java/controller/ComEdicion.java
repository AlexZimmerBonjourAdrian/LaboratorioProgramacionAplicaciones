...
public class ComEdicion extends HttpServlet {
    ...
    private String mostrarComentarios(List<DtComentarios> comentarios, int tab){
        ...
        for(Object datos : comentarios){
            ...
            result = result + "<p>"+  espacios + coment.getDatosEst().getNick() + " dice: " +coment.getComentario() + "</p><div id=\"campo"+coment.getId()+"\">"+espacios+"<input type=\"text\" id=\""+ coment.getId()+"\"><input type=\"button\" value=\"enviar\" onclick=enviarRespuesta(\""+coment.getId()+"\")></div>" + mostrarComentarios(coment.getRespuestas(), ++tab);
            tab--;
        } 
        return result;
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        result = mostrarComentarios(port.obtenerComentariosEdicion(nombreE),0);
        j.put("result",result);
